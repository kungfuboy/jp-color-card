export default [
    ...
    { label: '蜜柑色', jp: 'みかんいろ', color: '#f08300' },
    { label: '柳色', jp: 'やなぎいろ', color: '#a8c97f' },
    { label: '紺色', jp: 'こんいろ', color: '#223a70' },
    { label: '胡粉色', jp: 'ごふんいろ', color: '#fffffc' },
    { label: '枯草色', jp: 'かれくさいろ', color: '#e4dc8a' },
    { label: '鉛丹色', jp: 'えんたんいろ', color: '#ec6d51' },
    { label: '青白橡', jp: 'あおしろつるばみ', color: '#9ba88d' },
    { label: '紺青', jp: 'こんじょう', color: '#192f60' },
    { label: '卯の花色', jp: 'うのはないろ', color: '#f7fcfe' },
